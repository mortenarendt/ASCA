...
for i=1:nterms
    ...
    psca(i) = res{i}.p_sca;
    S2Ndt(i) = res{i}.S2Ndataspace;
    S2Nsca(i) = res{i}.S2Nsca;
end
...
atab = [lbSS cellstr(num2str(SS,3)) ...
    ...
    [cellstr(num2str(S2Ndt',2)); {' '};{' '}] ...
    [cellstr(num2str(S2Nsca',2)); {' '};{' '}] ...
    [cellstr(num2str(df',3)); {' '};{' '}] ...
    [cellstr(num2str(balancedness',3)); {' '};{' '}] ...
    [cellstr(num2str(p',3)); {' '};{' '}] ...
    [cellstr(num2str(psca',3)); {' '};{' '}] ...
    [cellstr(num2str(pest','%1.3g')); {' '};{' '}]];
atab = [{'Factor' 'SS' 'SS/SStot' 'SSmarg/SStot' 'S2Ndata' 'S2Nsca' 'DF' 'BalNess' 'P-value-freq' 'P-value-sca' 'P-value-Fest'};atab];
